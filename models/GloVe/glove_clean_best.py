...
pd.DataFrame(data=list(norms.values()),columns=norms["1"].keys(),index=list(norms.keys())).to_csv("./models/GloVe/glove/preprocessing/cosine_similarity_matrix.csv")
cosine_similarity_matrix = pd.read_csv("./models/GloVe/glove/preprocessing/cosine_similarity_matrix.csv", index_col=0)
...
outfile = open("./models/GloVe/glove/results/myresults_cos_500.txt", "w")
...
outfile = open("./models/GloVe/glove/results/myqrels_cos_500.txt", "w")
